...
export enum Collections {
	...
	EstatesCommonView = "estates_common_view",
	Flats = "flats",
	...
	Posts = "posts",
	PostsCommonView = "posts_common_view",
...
export type EstatesCommonViewRecord = {
	description: string
	id: string
	images?: string[]
	likesCount?: number
...
export enum PostsCommonViewStatusOptions {
	"draft" = "draft",
	"published" = "published",
	"pending" = "pending",
}

export enum PostsCommonViewTypeOptions {
	"blog" = "blog",
	"journal" = "journal",
	"portfolio" = "portfolio",
}
export type PostsCommonViewRecord<Tcontent_json = unknown, Tservices = unknown> = {
	author: RecordIdString
	authorAvatar?: string
...
export type UsersProfileViewRecord<TcontractorCitiesList = unknown, Tservices = unknown> = {
	about?: string
	age?: number
	avatar?: string
	blogCount?: number
...
export type EstatesCommonViewResponse<Texpand = unknown> = Required<EstatesCommonViewRecord> & BaseSystemFields<Texpand>
...
export type PostsCommonViewResponse<Tcontent_json = unknown, Tservices = unknown, Texpand = unknown> = Required<PostsCommonViewRecord<Tcontent_json, Tservices>> & BaseSystemFields<Texpand>
...
export type UsersProfileViewResponse<TcontractorCitiesList = unknown, Tservices = unknown, Texpand = unknown> = Required<UsersProfileViewRecord<TcontractorCitiesList, Tservices>> & BaseSystemFields<Texpand>
...
export type CollectionRecords = {
	...
	estates_common_view: EstatesCommonViewRecord
	flats: FlatsRecord
	...
	posts: PostsRecord
	posts_common_view: PostsCommonViewRecord
...
export type CollectionResponses = {
	...
	estates_common_view: EstatesCommonViewResponse
	flats: FlatsResponse
	...
	posts: PostsResponse
	posts_common_view: PostsCommonViewResponse
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'estates_common_view'): RecordService<EstatesCommonViewResponse>
	...
	collection(idOrName: 'posts_common_view'): RecordService<PostsCommonViewResponse>
