...
export enum Collections {
  ...
  PopularPostsView = "popular_posts_view",
...
export enum PopularPostsViewStatusOptions {
  "draft" = "draft",
  "published" = "published",
  "pending" = "pending",
}

export enum PopularPostsViewTypeOptions {
  "blog" = "blog",
  "journal" = "journal",
  "portfolio" = "portfolio",
}
export type PopularPostsViewRecord<
  TauthorAvatar = unknown,
  TauthorUsername = unknown,
  TcommentsCount = unknown,
  Tcontent_json = unknown,
  TflatId = unknown,
  TflatName = unknown,
  TlikesCount = unknown,
  Tservices = unknown,
> = {
  author: RecordIdString;
  authorAvatar?: null | TauthorAvatar;
  authorUsername?: null | TauthorUsername;
  commentsCount?: null | TcommentsCount;
  content_json?: null | Tcontent_json;
  created?: IsoDateString;
  flatId?: null | TflatId;
  flatName?: null | TflatName;
  id: string;
  images?: string[];
  lastComments?: RecordIdString[];
  likesCount?: null | TlikesCount;
  publishDate?: IsoDateString;
...
export type UsersProfileViewRecord<
  TblogCount = unknown,
  TcontractorCitiesList = unknown,
  TflatsCount = unknown,
  TportfolioCount = unknown,
  TpostCount = unknown,
  TserviceCount = unknown,
  Tservices = unknown,
> = {
  about?: string;
  age?: number;
...
export type BlogPostsResponse<Texpand = unknown> = Required<BlogPostsRecord> &
  BaseSystemFields<Texpand>;
export type CommentsPostsResponse<Texpand = unknown> =
  Required<CommentsPostsRecord> & BaseSystemFields<Texpand>;
export type ContractorsCitiesResponse<Texpand = unknown> =
  Required<ContractorsCitiesRecord> & BaseSystemFields<Texpand>;
export type ContractorsPostsResponse<Texpand = unknown> =
  Required<ContractorsPostsRecord> & BaseSystemFields<Texpand>;
export type ContractorsServicesResponse<Texpand = unknown> =
  Required<ContractorsServicesRecord> & BaseSystemFields<Texpand>;
export type DictBalconyResponse<Texpand = unknown> =
  Required<DictBalconyRecord> & BaseSystemFields<Texpand>;
export type DictBuildYearResponse<Texpand = unknown> =
  Required<DictBuildYearRecord> & BaseSystemFields<Texpand>;
export type DictBuildingCategoryResponse<Texpand = unknown> =
  Required<DictBuildingCategoryRecord> & BaseSystemFields<Texpand>;
export type DictCeilingHeightResponse<Texpand = unknown> =
  Required<DictCeilingHeightRecord> & BaseSystemFields<Texpand>;
export type DictCitiesResponse<Tcoords = unknown, Texpand = unknown> = Required<
  DictCitiesRecord<Tcoords>
> &
  BaseSystemFields<Texpand>;
export type DictElevatorResponse<Texpand = unknown> =
  Required<DictElevatorRecord> & BaseSystemFields<Texpand>;
export type DictFinishingResponse<Texpand = unknown> =
  Required<DictFinishingRecord> & BaseSystemFields<Texpand>;
export type DictFlatTypeResponse<Texpand = unknown> =
  Required<DictFlatTypeRecord> & BaseSystemFields<Texpand>;
export type DictFloorResponse<Texpand = unknown> = Required<DictFloorRecord> &
  BaseSystemFields<Texpand>;
export type DictFloorStructureResponse<Texpand = unknown> =
  Required<DictFloorStructureRecord> & BaseSystemFields<Texpand>;
export type DictHouseSeriesResponse<Texpand = unknown> =
  Required<DictHouseSeriesRecord> & BaseSystemFields<Texpand>;
export type DictLayoutResponse<Texpand = unknown> = Required<DictLayoutRecord> &
  BaseSystemFields<Texpand>;
export type DictObjectStatusResponse<Texpand = unknown> =
  Required<DictObjectStatusRecord> & BaseSystemFields<Texpand>;
export type DictParkingResponse<Texpand = unknown> =
  Required<DictParkingRecord> & BaseSystemFields<Texpand>;
export type DictPostTagsResponse<Texpand = unknown> =
  Required<DictPostTagsRecord> & BaseSystemFields<Texpand>;
export type DictPricePerM2Response<Texpand = unknown> =
  Required<DictPricePerM2Record> & BaseSystemFields<Texpand>;
export type DictRegionsResponse<Texpand = unknown> =
  Required<DictRegionsRecord> & BaseSystemFields<Texpand>;
export type DictServiceCategoriesResponse<Texpand = unknown> =
  Required<DictServiceCategoriesRecord> & BaseSystemFields<Texpand>;
export type DictSpecialtiesResponse<Texpand = unknown> =
  Required<DictSpecialtiesRecord> & BaseSystemFields<Texpand>;
export type DictSpecialtyServicesResponse<Texpand = unknown> =
  Required<DictSpecialtyServicesRecord> & BaseSystemFields<Texpand>;
export type DictSquareM2Response<Texpand = unknown> =
  Required<DictSquareM2Record> & BaseSystemFields<Texpand>;
export type DictStoreysResponse<Texpand = unknown> =
  Required<DictStoreysRecord> & BaseSystemFields<Texpand>;
export type FlatsResponse<Texpand = unknown> = Required<FlatsRecord> &
  BaseSystemFields<Texpand>;
export type HouseSeriesCardsResponse<Texpand = unknown> =
  Required<HouseSeriesCardsRecord> & BaseSystemFields<Texpand>;
export type JournalsResponse<Texpand = unknown> = Required<JournalsRecord> &
  BaseSystemFields<Texpand>;
export type LikesCommentsPostsResponse<Texpand = unknown> =
  Required<LikesCommentsPostsRecord> & BaseSystemFields<Texpand>;
export type LikesFlatsResponse<Texpand = unknown> = Required<LikesFlatsRecord> &
  BaseSystemFields<Texpand>;
export type LikesPostsResponse<Texpand = unknown> = Required<LikesPostsRecord> &
  BaseSystemFields<Texpand>;
export type PopularPostsViewResponse<
  TauthorAvatar = unknown,
  TauthorUsername = unknown,
  TcommentsCount = unknown,
  Tcontent_json = unknown,
...
> &
  BaseSystemFields<Texpand>;
export type PostFlatsResponse<Texpand = unknown> = Required<PostFlatsRecord> &
  BaseSystemFields<Texpand>;
export type PostServicesResponse<Texpand = unknown> =
  Required<PostServicesRecord> & BaseSystemFields<Texpand>;
export type PostsResponse<
  Tcontent_json = unknown,
  Texpand = unknown,
> = Required<PostsRecord<Tcontent_json>> & BaseSystemFields<Texpand>;
export type SubscriptionsAuthorsResponse<Texpand = unknown> =
  Required<SubscriptionsAuthorsRecord> & BaseSystemFields<Texpand>;
export type UserProfilesResponse<Texpand = unknown> =
  Required<UserProfilesRecord> & BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type UsersProfileViewResponse<
  TblogCount = unknown,
  TcontractorCitiesList = unknown,
  TflatsCount = unknown,
  TportfolioCount = unknown,
  ...
  Texpand = unknown,
> = Required<
  UsersProfileViewRecord<
    TblogCount,
    TcontractorCitiesList,
    TflatsCount,
    TportfolioCount,
    TpostCount,
    TserviceCount,
...
export type CollectionRecords = {
  ...
  popular_posts_view: PopularPostsViewRecord;
...
export type CollectionResponses = {
  ...
  popular_posts_view: PopularPostsViewResponse;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: "contractors_cities",
  ): RecordService<ContractorsCitiesResponse>;
  collection(
    idOrName: "contractors_posts",
  ): RecordService<ContractorsPostsResponse>;
  collection(
    idOrName: "contractors_services",
  ): RecordService<ContractorsServicesResponse>;
  ...
  collection(
    idOrName: "dict_building_category",
  ): RecordService<DictBuildingCategoryResponse>;
  collection(
    idOrName: "dict_ceiling_height",
  ): RecordService<DictCeilingHeightResponse>;
  ...
  collection(
    idOrName: "dict_floor_structure",
  ): RecordService<DictFloorStructureResponse>;
  collection(
    idOrName: "dict_house_series",
  ): RecordService<DictHouseSeriesResponse>;
  collection(idOrName: "dict_layout"): RecordService<DictLayoutResponse>;
  collection(
    idOrName: "dict_object_status",
  ): RecordService<DictObjectStatusResponse>;
  ...
  collection(
    idOrName: "dict_price_per_m2",
  ): RecordService<DictPricePerM2Response>;
  collection(idOrName: "dict_regions"): RecordService<DictRegionsResponse>;
  collection(
    idOrName: "dict_service_categories",
  ): RecordService<DictServiceCategoriesResponse>;
  collection(
    idOrName: "dict_specialties",
  ): RecordService<DictSpecialtiesResponse>;
  collection(
    idOrName: "dict_specialty_services",
  ): RecordService<DictSpecialtyServicesResponse>;
  ...
  collection(
    idOrName: "house_series_cards",
  ): RecordService<HouseSeriesCardsResponse>;
  collection(idOrName: "journals"): RecordService<JournalsResponse>;
  collection(
    idOrName: "likes_comments_posts",
  ): RecordService<LikesCommentsPostsResponse>;
  ...
  collection(
    idOrName: "popular_posts_view",
  ): RecordService<PopularPostsViewResponse>;
  ...
  collection(
    idOrName: "subscriptions_authors",
  ): RecordService<SubscriptionsAuthorsResponse>;
  collection(idOrName: "user_profiles"): RecordService<UserProfilesResponse>;
  collection(idOrName: "users"): RecordService<UsersResponse>;
  collection(
    idOrName: "users_profile_view",
  ): RecordService<UsersProfileViewResponse>;
};
